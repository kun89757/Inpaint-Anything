...
def demo(model):
    ...
    def get_inpainted_img(img, mask0, mask1, mask2, text_prompt):
        ...
        for mask in [mask0, mask1, mask2]:
            ...
            img_replaced_normalized = normalize_img(img_filled)
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row().style(mobile_collapse=False, equal_height=True):
            ...
            with gr.Column(variant="panel"):
                ...
                text_prompt = gr.Textbox(label="Text Prompt", info="提示词")
        ...
        with gr.Row(variant="panel"):
            with gr.Column():
                ...
                with gr.Row():
                    lama1 = gr.Button("Inpaint Image", variant="primary").style(full_width=True, size="sm")
                    lama2 = gr.Button("Inpaint Image", variant="primary").style(full_width=True, size="sm")
                    lama3 = gr.Button("Inpaint Image", variant="primary").style(full_width=True, size="sm")
        ...
        img_rm_with_mask_0, text_prompt
        )

        lama2.click(
        get_single_inpainted_img,
        [img, mask_1, text_prompt],
        img_rm_with_mask_1, text_prompt
        )

        lama3.click(
        get_single_inpainted_img,
        [img, mask_2],
        img_rm_with_mask_2,text_prompt
        )
        ...
        clear_button_image.click(
            reset,
            [img, features, img_pointed, w, h, mask_0, mask_1, mask_2, img_with_mask_0, img_with_mask_1, img_with_mask_2,
             img_rm_with_mask_0, img_rm_with_mask_1, img_rm_with_mask_2],
            [img, features, img_pointed, w, h, mask_0, mask_1, mask_2, img_with_mask_0, img_with_mask_1, img_with_mask_2,
             img_rm_with_mask_0, img_rm_with_mask_1, img_rm_with_mask_2]
        )
